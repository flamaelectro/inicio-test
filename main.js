...
var NODE_TLS_REJECT_UNAUTHORIZED = '0'; // ⚠️ Elimina esto en producción (es inseguro)

// --- Evento para popups ---
webview.addEventListener('newwindow', (e) => {
  e.preventDefault();
  webview.src = e.targetUrl; // Abre en la misma ventana
});
...
webview.addEventListener('permissionrequest', function(e) {
  if (e.permission === 'download') e.request.allow();
});
